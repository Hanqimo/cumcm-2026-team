...
def main():
    ...
    try:
        ...
        from strategy import Planner, VERSION
    ...
    if args.check:
        ...
        return 0
    print(f'问题3改进策略 {VERSION} | 端口 {port}')
    ...
    (folder / 'manifest.json').write_text(json.dumps(dict(strategy=VERSION,
    ...
    try:
        ...
        summary = dict(strategy=VERSION, outcome=outcome, error=error_text,
