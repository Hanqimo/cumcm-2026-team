...
class JointPlanner(BasePlanner):
    def __init__(self, robot, *, family='joint', scan_gain=.05, info_distance=150.,
                 ...
                 joint_negatives=False,shared_waypoint=False,explore_bonus=0.,expected_count=13.,coverage_value=False,coverage_value_threshold_s=10.,motion='side',first_fraction=1.):
