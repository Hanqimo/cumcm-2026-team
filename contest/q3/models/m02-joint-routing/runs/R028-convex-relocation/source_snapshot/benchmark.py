...
def main():
    ...
    for name,params in config.items():
        ...
        specs[name]=({'sector':SectorPlanner,'ordered':OrderedPlanner,'sticky':StickyPlanner,'target_first':TargetFirstPlanner,'path_cover':PathCoverPlanner,'convex_cover':ConvexCoverPlanner}.get(kind,JointPlanner),params)
