...
from joint_strategies import JointPlanner, SweepPlanner, SectorPlanner, OrderedPlanner, StickyPlanner,TargetFirstPlanner
...
def main():
    ...
    for name,params in config.items():
        ...
        specs[name]=({'sector':SectorPlanner,'ordered':OrderedPlanner,'sticky':StickyPlanner,'target_first':TargetFirstPlanner}.get(kind,JointPlanner),params)
