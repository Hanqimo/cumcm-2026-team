...
from joint_strategies import JointPlanner, SweepPlanner, SectorPlanner, OrderedPlanner, StickyPlanner
...
def main():
    ...
    for name,params in config.items():
        ...
        specs[name]=({'sector':SectorPlanner,'ordered':OrderedPlanner,'sticky':StickyPlanner}.get(kind,JointPlanner),params)
