...
def main():
    ...
    parser.add_argument('--policy', choices=['directional_v1','mesh_chase_baseline'], default='directional_v1', help='默认第四问方向可见性与三角网策略')
    ...
    if not team:
        ...
        return 2
    if args.check:
        print(f'策略 {args.policy}；第四问初版，仅完成本地验证。')
